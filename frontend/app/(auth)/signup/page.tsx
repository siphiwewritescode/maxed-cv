  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          {password.length > 0 && (
            <div style={{
              ...
              <div style={{ fontSize: '12px', lineHeight: '1.8' }}>
                <div style={{
                  color: passwordRequirements.minLength ? '#28a745' : '#666',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '6px'
                }}>
                ...
                <div style={{
                  color: passwordRequirements.hasUpperCase ? '#28a745' : '#666',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '6px'
                }}>
                ...
                <div style={{
                  color: passwordRequirements.hasLowerCase ? '#28a745' : '#666',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '6px'
                }}>
                ...
                <div style={{
                  color: passwordRequirements.hasNumber ? '#28a745' : '#666',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '6px'
                }}>
                ...
                <div style={{
                  color: passwordRequirements.hasSymbol ? '#28a745' : '#666',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '6px'
                }}>
                  <span>{passwordRequirements.hasSymbol ? '✓' : '○'}</span>
        ...
        <button
          type="submit"
          disabled={loading || !allRequirementsMet || !email || !firstName || !lastName}
          style={{
            width: '100%',
            padding: '12px',
            fontSize: '16px',
            fontWeight: 600,
            color: '#fff',
            backgroundColor: (loading || !allRequirementsMet || !email || !firstName || !lastName) ? '#ccc' : '#0070f3',
            border: 'none',
            borderRadius: '6px',
            cursor: (loading || !allRequirementsMet || !email || !firstName || !lastName) ? 'not-allowed' : 'pointer',
            marginBottom: '16px',
          }}
        >
